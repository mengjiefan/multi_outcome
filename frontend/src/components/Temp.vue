<template>
    <div id="DirectedGraph">
      ...
      <h3 style="color:red;font-size:25px;">Todo:To achieve real-time rendering</h3>
      ...
      <button @click="drawGraph" style="background-color: #FFC0CB;">Show the Directed Graph</button>
      <hr/>
