...
if args.save_folder:
    ...
    safe_name = save_folder.replace(':', '_')
    print(safe_name)
    save_folder = safe_name
...
optimizer = None
variable_size = 0
def init_model(data_variable_size):
    global encoder
    global decoder
    global optimizer
    global rel_rec
    ...
    variable_size = data_variable_size
...
def train(epoch, best_val_loss, lambda_A, c_A, train_loader):
    global encoder
    global decoder
    global optimizer
    global rel_rec
    ...
    for batch_idx, (data, relations) in enumerate(train_loader):
        ...
        dec_x, output, adj_A_tilt_decoder = decoder(data, edges,variable_size * args.x_dims, rel_rec, rel_send, origin_A, adj_A_tilt_encoder, Wa)
        ...
        # compute h(A)
        h_A = _h_A(origin_A, variable_size)
